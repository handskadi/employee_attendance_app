...
def edit_employee(employee_id):
    ...
    if form.validate_on_submit():
        ...
        # Note: You may need to customize this based on your database schema
        uploaded_image = form.image.data
        if uploaded_image == None and employee[9] != 'default.png':
            uploaded_image = employee[9]
        elif uploaded_image == None and employee[9] == 'default.png':
